...
description: A quick perspective on using LLMs as search engines
date: "2025-05-03"
tags: llms, data, search
standardUri: "at://did:plc:nevxkulynwc5m2sk4jalv4c7/site.standard.document/llms-as-search-engines"
---
...
The superpower that LLMs provide — and why Google created them in the first place — is that they do a phenomenal job of estimating the _intent_ behind an arbitrarily complex query, thereby allowing a user to express their query in a way that is most natural to them. This has always been a problem with Google in the past, and why "googling as a skill" is a thing, because some folks have learned very particular tricks to get better results, but most of these tricks aren't known by the average person, let alone anyone who doesn't know how to game the SEO world. **LLMs solve this problem for the average person**.
...
In about 3 years we've seen a fun chatbot turn into, much to the chagrin of some, an essential piece of information infrastructure for the entire world. They have wholly replaced some systems, including search systems, for many people, and they can often do a better job of it. This is a phenomenal advancement in computing, even though there's clearly so much further to go. I hope that more folks understand the risks involved in using this tech as search engines, so that we can all take the very useful capabilities we now have and use them truly to our advantage instead of our detriment.
