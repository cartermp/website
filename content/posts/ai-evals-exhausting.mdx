...
date: "2025-11-23"
tags: ai, llms
standardUri: "at://did:plc:nevxkulynwc5m2sk4jalv4c7/site.standard.document/ai-evals-exhausting"
---

It can be exhuasting keeping up with AI improvements. Really it comes down to two reasons:

1. Models materially improve month over month across several domains and for many different tasks, but not in a way you can predict
2. Industry standard benchmarks are usually meaningless (but not always!)
...
Moreover, and this is perhaps the most important part of it all, sometimes a newer model means you can simply do different and more interesting things than could be done before. By definition, you don't have evals you can run against things you haven't built yet. **Evals are great, but they necessarily look backwards, not forwards.**
