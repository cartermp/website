...
date: "2025-03-02"
tags: llms, data
standardUri: "at://did:plc:nevxkulynwc5m2sk4jalv4c7/site.standard.document/llms-computers"
---
...
2. Calculating the understanding of a phrase
...
In 2024, not only did [LLMs get much faster to run](./llm-training-efficiency), but multi-modality went mainstream. Now you can do things like:
