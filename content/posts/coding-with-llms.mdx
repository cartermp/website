...
Web development, relatively boring backend development, mobile development, library development, and "CNCF-adjacent" cloud development (i.e., written in Go and deployed to kubernetes), are some domains that I've found AI models do well with. This is mostly due to the vast amount of this sort of code available that modern AI models pre-train on.
