        ...
        <div className="relative grid gap-10 lg:grid-cols-[1.2fr,0.8fr] lg:items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              <span className="chip-ghost">LLMs & data</span>
              <span className="chip-ghost">DevEx habits</span>
              <span className="chip-ghost">Systems & scale</span>
              <span className="chip-ghost">People & tradeoffs</span>
            </div>
          </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3 text-xs text-slate-600 dark:text-slate-300">
            ...
            <span className="hidden md:block">
              {posts.length} entries on engineering, product, and the messy middle.
            </span>
          </div>
        </div>
