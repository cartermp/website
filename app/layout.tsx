    ...
    <html lang="en" suppressHydrationWarning>
      ...
      >
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem disableTransitionOnChange>
          <div className="relative isolate min-h-screen overflow-hidden bg-slate-100 dark:bg-slate-950 selection:bg-lime-200 selection:text-slate-900 dark:selection:bg-emerald-400/30">
            ...
            <div className="relative max-w-6xl mx-auto px-6 py-12 lg:py-16">
              <div className="grid gap-8 lg:grid-cols-[320px_1fr]">
                <aside className="h-fit sticky top-8 rounded-3xl border border-slate-200/80 dark:border-slate-800/80 bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl shadow-[0_20px_90px_rgba(15,23,42,0.25)] p-6 lg:p-8 space-y-8">
                  <Link
                    href="/"
